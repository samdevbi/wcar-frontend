...
import { CREATE_NOTIFICATION, LIKE_MEMBER, SUBSCRIBE, UNSUBSCRIBE } from '../../apollo/user/mutation';
...
import Notification from '../../libs/components/mypage/Notifications';
						...
						<Stack className={'back-frame'}>
							...
							<Stack className="main-config" mb={'76px'}>
								<Stack className={'list-config'}>
									...
									{category === 'notification' && <Notification redirectToMemberPageHandler={redirectToMemberPageHandler} />}
