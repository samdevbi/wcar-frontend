...
const AddProduct = ({ initialValues, ...props }: any) => {
	...
	const {
		...
		variables: router?.query?.productId ? { input: router.query.productId } : undefined,
	});

	console.log("yangi data", getProductData?.getProduct);
	...
	useEffect(() => {
		setInsertProductData({
			...
			productShortDesc: getProductData?.getProduct ? getProductData?.getProduct?.productShortDesc : '',
			productDesc: getProductData?.getProduct ? getProductData?.getProduct?.productDesc : '',
			productQuantity: getProductData?.getProduct ? getProductData?.getProduct?.productQuantity : 0,
				...
				<div>
					<Stack className="config">
						<Stack className="description-box">
							...
							<Stack className="config-row">
								<Stack className="price-year-after-price">
									<Typography className="title">{t('Short Desc')}</Typography>
									<input
										type="text"
										className="description-input"
								...
								<Stack className="price-year-after-price">
									<Typography className="title">{t('Quantity')}</Typography>
									<input
										type="number"
										className="description-input"
							...
							<Typography className="property-title">{t('Product Description')}</Typography>
							<Stack className="config-column">
						...
						<Typography className="upload-title">{t('Upload photos of your product')}</Typography>
